...
def rolling_upgrade_version_revisions():
    ...
    return [
        {
            "revision": "apache/{}".format(cassandra_2_2),
        ...
        },
        {
            ...
            "revision_override": {"apache/{}".format(cassandra_3_0): [NODES[0]]},
            "cluster_name": "updating_cluster"
        },
        {
            "revision": "apache/{}".format(cassandra_2_2),
            "label": "step_2_  1 {} Nodes, 2 {} Nodes".format(cassandra_2_2, cassandra_3_0),
            "revision_override": {"apache/{}".format(cassandra_3_0): [NODES[0], NODES[1]]},
            "cluster_name": "updating_cluster"
        },
        {
            "revision": "apache/{}".format(cassandra_3_0),
